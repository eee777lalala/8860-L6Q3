...
def hello_world():
    ...
    if request_type_str == 'GET':
        ...
        model = load('app/travel-destination.joblib')
        ...
        return render_template('index.html', href2='The suitable bread for you (salary:'+str(mysalary)+' ,gender:'+str(mygender)+' ,marital:'+str(mymarital)+' , is:'+predictions_to_str)
